...
[v37.1 DB 안전 보강]
- 주문 수정 가격등급은 클라이언트 전달값이 아니라 profiles에서 DB가 직접 확인
- 수금 등록은 payments만 생성하고 기존 create_ledger_on_payment 트리거가 장부를 생성하여 이중 장부 방지
- SQL 설치 시 기존 주문/품목/장부/회원/상품 데이터 삭제 없음
