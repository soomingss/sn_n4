...
export default function TaxReportClient() {
  ...
  return <>
    ...
    <p className="taxReportNote">배송완료 처리된 거래를 기준으로 집계합니다. 국산은 면세, 수입산은 과세로 구분하며 수입산 판매가격은 부가세 10% 포함금액으로 계산합니다. 엑셀은 기본적으로 거래처별 월 합계만 다운로드되며, ‘상품명 포함 표시하기’를 선택하면 상품별 상세내역 시트가 함께 포함됩니다.</p>
