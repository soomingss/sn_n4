...
export default function ProductsClient({ products = [], companyName = "" }) {
  ...
  return <section className="productSection contentWidth">
    <div className="productIntro"><h1>한약재 제품안내</h1><p>원하시는 품목을 검색하고 바로 주문할 수 있습니다. <strong>(약재의 단가는 수급현황에 따라 달라질 수 있습니다)</strong></p></div>
