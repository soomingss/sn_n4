  ...
  return (
    <header className="header">
      ...
      <nav className="mainNav">
        <Link href="/company">회사소개</Link><Link href="/products">제품안내</Link><Link href="/order-delivery">주문·배송 안내</Link>{kakaoChannelUrl && <a href={kakaoChannelUrl} target="_blank" rel="noopener noreferrer">고객센터</a>}{isAdmin && <Link className="adminNavLink" href="/admin">관리자업무</Link>}
      </nav>
