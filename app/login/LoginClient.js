...
export default function LoginClient({ companyNameEn }) {
  ...
  return <main>
    <section className="companyHero loginHero"><div className="companyHeroCopy"><p>{companyNameEn}</p><h1>로그인</h1><span>HOME &gt; 로그인</span></div></section>
